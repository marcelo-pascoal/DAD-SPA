...
const userTitle = computed(()=>{
  ...
  return props.inserting ? 'Register a new ' + props.type : props.type + '#' + editingUser.value.id
})
  ...
  <form class="row g-3 needs-validation" novalidate @submit.prevent="save">
    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="w-75 pe-4">
        <div class="d-flex">
          ...
          <div v-if="props.type=='vcard'" class="mb-3">
            ...
            <input type="text" class="form-control" :class="{ 'is-invalid': errors ? errors['phone_number'] : false }"
              id="inputPhoneNumber" required v-model="editingUser.phone_number" :disabled="!inserting">
        ...
        <div class="mb-3" v-if="!inserting | props.type=='vcard'">
        ...
        <div class="mb-3" v-if="props.type=='vcard'">
        ...
        <div class="mb-3"  v-if="props.type=='vcard'">
          ...
          <input type="password" class="form-control" id="inputConfirmationCodeConfirmation" v-model="editingUser.confirmation_code_confirmation"/>
